...
template <class T>
class Mat4 {
public: // !!!!! ADDED THIS TO FIX A BUG IN THE GIVEN LIBRARY USING BRUTE FORCE -Ian !!!!!
...
// public: // !!!!! COMMENTED THIS TO FIX A BUG IN THE GIVEN LIBRARY USING BRUTE FORCE -Ian !!!!!
